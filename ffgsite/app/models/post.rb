class Post < ActiveRecord::Base
  attr_accessible :sms_body,:p1,:p2,:p3,:p4,:p5,:np1,:np2,:np3,:nn1,:nn2
  belongs_to :user
  ...
  def meaningful_p
    (meaningful(self.p1) && meaningful(self.p2) && meaningful(self.p3) && meaningful(self.p4) && meaningful(self.p5))
  end
